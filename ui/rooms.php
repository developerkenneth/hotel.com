...
<head>
    ...
    <title>Rooms Management - Hotel.com</title>
    ...
    <main class="main-content">
        ...
        <section class="dashboard-content">
            <div class="page-heading">
                ...
                <button class="primary-button">+ Add New Room</button>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($rooms as $room): ?>
                                <tr>
                                    ...
                                    <td><span class="status <?= htmlspecialchars($room['badge']) ?>"><?= htmlspecialchars($room['status']) ?></span></td>
