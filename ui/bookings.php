...
<head>
    ...
    <title>Bookings - Hotel.com</title>
    ...
    <main class="main-content">
        ...
        <section class="dashboard-content">
            <div class="page-heading">
                ...
                <button class="primary-button">+ Create Reservation</button>
            </div>
